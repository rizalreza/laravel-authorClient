			...
			<form class="" action="<?php echo e(route('book.store')); ?>" method="post">
				...
				<div class="form-group">
					...
					<select type="text" class="form-control" name="author_id" required autofocus>
                        ...
                        <?php $__currentLoopData = $contentAuthor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
